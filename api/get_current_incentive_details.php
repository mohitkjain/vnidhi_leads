...
$app->post('/api/incentive/current', function ($request, $response) 
{
            ...
            if ($stmt_rd->execute()) 
            {
                ...
                if ($stmt_fd->execute()) 
                {
                    ...
                    if(isset($current_data))
                    {
                        ...
                        $current_month_target = $current_data->current_month_target;
                        $current_month_achieved = $current_data->current_month_achieved;

                        if($current_month_achieved < $current_month_target)
                        {
                            $total_fd_incentive = 0;
                            $array  = array();
                        ...
                        $total->current_month = $current_month;
                        $total->current_year = $current_year;
                    }                   
                }
                if($total) 
                {
